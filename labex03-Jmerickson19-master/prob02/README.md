...
*Note: This problem can be solved by using the C++ built-in function pow found in the cmath library. However, the goal is to practice using loops, so you get full points only if you use loops.*
...
<pre>
Please enter the base number: <b>3</b>
Please enter the power: <b>-3</b>
Negative powers are currently unsupported.
</pre>
