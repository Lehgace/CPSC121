...
Make sure that you write the `power` function prototype in `power.hpp` and its implementation in `power.cpp`, and call the function from `main.cpp`. You'll find that skeleton code has already been provided for `main.cpp` and you simply need to call the function and include the necessary header files.

Please see the samples below. Note that <b>bold</b> values in the samples represent input by the user.

## Sample input/output:
<pre>
Please enter the base number: <b>5</b>
Please enter the power: <b>3</b>
5 ^ 3 = 125
</pre>
### Sample #2
<pre>
Please enter the base number: <b>2.5</b>
Please enter the power: <b>3</b>
2.5 ^ 3 = 15.625
</pre>
### Sample with negative power
<pre>
Please enter the base number: <b>4</b>
Please enter the power: <b>-2</b>
4 ^ -2 = 0.06
</pre>
