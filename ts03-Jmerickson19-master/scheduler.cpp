                   ...
                   int & courses_size)
{
  ...
  else
  {
    while (getline(input_file, course) && valid)
    {
      ...
      courses[courses_size].set_course_name(course);
      courses[courses_size].set_location(location);
      courses[courses_size].set_weekly_schedule(day_symbol);
      courses[courses_size].set_start_time(start_time);
      courses[courses_size].set_end_time(end_time);
      courses_size++;
