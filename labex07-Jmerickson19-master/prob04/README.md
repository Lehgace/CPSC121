...
Place the `linear_search`'s function prototype in `lsa.hpp` and its implementation in `lsa.cpp`. The `main` function already contains some code, but you need to complete the requirements that is described inside the file.
